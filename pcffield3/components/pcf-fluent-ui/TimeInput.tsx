...
import { ComboBox, IComboBoxOption, IComboBoxProps, IComboBox } from "office-ui-fabric-react";
...
export class TimeInput extends React.Component<TimeInputProps, TimeInputState> {
  ...
  onChange = async (event: React.FormEvent<IComboBox>, option?: IComboBoxOption, index?: number, value?: string) => {
